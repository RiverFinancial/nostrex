  defmodule Nostrex.FilterTest do
    ...
    @test_filters [
      ['{"ids":["aa","bb","cc"],"authors":["aa","bb","cc"],"kinds":[0,1,2,3],"since":1000,"until":1000,"limit":100,"#e":["aa","bb","cc"],"#p":["dd","ee","ff"],"#r":["00","11","22"]}', true],
      ...
      ['{"until": 2342342423}', true], # although we may want to block such large sweeping reqs
      ['{"ids":[123, 456]}', false],
      ['{"limit":[123]}', false],
      ['{"ids":[]}', false],
      # ['', false]
